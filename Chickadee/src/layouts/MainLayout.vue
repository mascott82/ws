<template>
  <q-layout view="lHr lpR fFf">
    <q-header bordered class="bg-white text-black">
      <q-toolbar>
        ...
        <q-toolbar-title class="text-weight-bold">
          ...
          <q-icon name="fa-brands fa-earlybirds" size="sm" color="primary" class="q-pa-md lt-md header-icon" />
        </q-toolbar-title>
      </q-toolbar>
    </q-header>

    <q-drawer :width="283" show-if-above v-model="leftDrawerOpen" side="left" bordered>
      <q-icon name="fa-brands fa-earlybirds" size="lg" color="primary" class="q-pa-md" />
      <q-list>
        <q-item
          to="/"
          exact
          ...
          <q-item-section avatar>
            <q-icon name="fa-solid fa-house-chimney-window" size="sm" />
          </q-item-section>
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <q-input class="q-ma-md" outlined rounded dense v-model="text" label="Search Deedee">
